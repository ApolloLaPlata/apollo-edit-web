...
---
## [MAPEAMENTO DA API CENTRAL DE INFER�NCIA (LIGHTNING AI)] (Data: 08/06/2026)

**A GRANDE DESCOBERTA:** 
N�o precisamos criar dezenas de "Agentes" isolados no painel da Lightning e capturar URLs diferentes. A Lightning AI prov� uma **API Universal Padr�o OpenAI**. 
Com uma �nica Chave de API, podemos chamar *QUALQUER* modelo trocando apenas a string do par�metro model.

**Endpoint Universal:** https://lightning.ai/api/v1/chat/completions
**Formato:** Id�ntico � API da OpenAI (Permite usar a biblioteca oficial openai do Python/Node).

### Exemplos de Chamada de Produ��o (Guardados para o Apollo):
...
**JavaScript (Fetch puro - �til para pain�is leves):**
`javascript
...
### TABELA DE MODELOS E CUSTOS (Refer�ncia para o Banco de Dados)
*(Nota: Valores parecem ser USD por 1 Milh�o de Tokens - Input / Output)*
...
## 6. A ARQUITETURA DEFINITIVA DOS AGENTES (PONTO DE VISTA DO USU�RIO)
*(Corre��o e Refinamento de UX - Data: 08/06/2026)*

Para n�o haver confus�o, o sistema de IA para o usu�rio final � dividido em tr�s entidades distintas e geniais:

### A. O Copiloto Personalizado (Roteirista Customizado do Cliente)
O usu�rio tem a liberdade de criar o seu pr�prio "Funcion�rio IA".
- **Aba de Cria��o:** Ele d� nome, foto, descreve a personalidade, o canal do YouTube, as fun��es exatas e habilidades especiais (Ex: "Especialista em criar roteiros de suspense").
- **Escolha do C�rebro:** O pr�prio usu�rio escolhe na lista qual Modelo de IA vai pilotar esse boneco (Ex: "Eu quero o GPT 3.5 Turbo pro meu roteirista").
- **Uso na Esteira:** Quando o usu�rio vai para a "Gera��o de V�deo Automatizado", ele seleciona o "seu" bonequinho roteirista. O custo desse bonequinho trabalhar � pago pelo usu�rio usando os quadradinhos m�gicos (Cristais), atrelado ao custo do modelo que ele mesmo escolheu.

### B. O Playground de IA (O "ChatGPT/Gemini" Interno do Apollo)
Uma aba dedicada exclusivamente para o usu�rio conversar livremente com IAs.
...
- **Recurso de Projetos:** Inspirado no Gemini, ele pode criar pastas/projetos e atrelar agentes com conhecimentos espec�ficos para ajudar a escrever textos, organizar ideias, antes de mandar para a linha de produ��o de v�deos.

### C. O Agente de Suporte Central (O Fantasma Omnipresente do Apollo)
Este � o rob� da plataforma (n�o o roteirista do cliente).
- Ele atende o cliente no WhatsApp, fica flutuando na interface do site e tira d�vidas.
- Sabe tudo sobre o cliente.
- Se o cliente estiver na aba de cria��o, esse rob� de suporte pode ajudar, mas sua fun��o principal � guiar e vender (Gerar or�amentos, receitas, direcionamentos).

Esta estrutura cria um ecossistema viciante onde o usu�rio se sente dono de uma ag�ncia de publicidade particular (com seus pr�prios roteiristas customizados) e paga alegremente a gasolina e os cristais para manter sua ag�ncia rodando.
