...
html = html.replace('<a href="" download class="btn btn-primary" style="white-space: nowrap; height: fit-content;">⬇️ Baixar</a>', '<button onclick="forceDownloadAudio(\\'\\')" class="btn btn-primary" style="white-space: nowrap; height: fit-content;">⬇️ Baixar</button>')
