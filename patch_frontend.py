...
# Correções no generateMusicTest
...
new_fetch = '''const response = await fetch(url, {
                ...
                while (true) {
                    ...
                    // Mantém a última parte no buffer caso não tenha quebra de linha ainda
                    buffer = lines.pop();
...
# Vou substituir o pedaço na unha porque as formatações podem variar.
# Usar start/end search com strings pequenas seguras
