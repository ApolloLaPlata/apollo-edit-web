...
export default async function Home(props: {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-3 text-center text-sm md:text-base font-bold shadow-lg z-50 relative w-full">
        <a href="https://apolloedit.com.br" target="_blank" rel="noopener noreferrer" className="hover:opacity-90 flex flex-col md:flex-row items-center justify-center gap-2">
          <span>🚀 Crie vídeos automáticos com Inteligência Artificial no Apollo Edit</span>
          <span className="bg-white text-blue-600 px-3 py-1 rounded-full text-xs ml-2 shadow-sm uppercase tracking-wide">Acessar Plataforma</span>
        </a>
      </div>
