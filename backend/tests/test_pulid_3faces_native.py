...
Passa as 3 imagens de referência REAIS para o workflow_3_faces.json
...
IMG_CRYING_MAN = r"C:\Users\v5est\Downloads\#Macacodriver.png"

WORKFLOW_PATH  = r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\Comfyui Workflow API\FLUX 2 DEV\image_flux2\workflow_3_faces.json"
OUTPUT_PATH    = r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\backend\tests\flux_pulid_3faces_native.jpg"
...
SCENE_PROMPT = (
    ...
    "a chimpanzee wearing a beige safari shirt on the right, "
    ...
    with app.run():
        result = engine.generate.remote(
            ...
            reference_images={
                ...
                "apollo_mask_3_0.png": img_to_b64(r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\backend\masks\apollo_mask_3_0.png"),
                "apollo_mask_3_1.png": img_to_b64(r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\backend\masks\apollo_mask_3_1.png"),
                "apollo_mask_3_2.png": img_to_b64(r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\backend\masks\apollo_mask_3_2.png")
            }
        )
