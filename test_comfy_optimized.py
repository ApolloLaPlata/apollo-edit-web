...
img_path = r"C:\Users\v5est\Downloads\Gemini_Generated_Image_9evpwk9evpwk9evp.png"
...
payload = {
    ...
    'prompt': 'faça esse personagem jogando futebol no campo',
    'format': 'square',
    'seed': 42,
...
try:
        ...
        if line:
            ...
            if len(line) > 5:
                try:
                    ...
                    if isinstance(data, dict) and ('image_base64' in data or data.get('status') == 'success'):
                        result = data
                except:
                    pass
    ...
    if result and 'image_base64' in result:
        ...
        out = 'testes_modal_output/elon_futebol_comfy.png'
        ...
        print(f'[ERRO] Resultado inesperado: {json.dumps(result)[:300] if result else "Nenhum resultado recebido"}', flush=True)
except Exception as e:
    elapsed = time.time() - t0
