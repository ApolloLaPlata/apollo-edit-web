    ...
    <div className="space-y-6">
      ...
      {profiles.length === 0 ? (
        <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-zinc-100 mb-2">Nenhum Canal Cadastrado</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-5 shadow-sm">
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
                {profiles.map(p => (
              ...
              {activeProfile && (
                <div className="mt-4 p-3 bg-transparent rounded-lg text-sm text-zinc-400 border border-zinc-100">
                  <p className="font-medium text-zinc-100 mb-1">Nicho / Descrição:</p>
              ...
              <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-5 shadow-sm">
                ...
                <div className="flex gap-2 mb-4">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <ul className="space-y-2">
                  {(activeProfile.competitors || []).map((comp, i) => (
                    <li key={i} className="flex items-center justify-between p-2 bg-transparent rounded-md border border-zinc-100 text-sm">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-gradient-to-br from-indigo-900 to-indigo-800 rounded-xl p-6 text-white shadow-md relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-zinc-900 text-indigo-900 font-semibold rounded-lg hover:bg-indigo-900/30 transition-colors disabled:opacity-70"
                >
                  {isAnalyzing ? (
                    <>
            ...
            {error && (
              <div className="p-4 bg-red-900/30 text-red-400 rounded-xl border border-red-100 flex items-start gap-3">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4">
                  {ideas.map((idea, index) => (
                    <div key={index} className="bg-zinc-900 rounded-xl border border-zinc-800 p-5 shadow-sm hover:border-indigo-300 transition-colors">
                      <div className="flex items-start justify-between gap-4 mb-3">
                        <h4 className="font-bold text-lg text-zinc-100 leading-tight">
                          {idea.title}
                        </h4>
                        <span className={`shrink-0 px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${
                          idea.urgency === 'Alta' ? 'bg-red-100 text-red-400' :
                      ...
                      <div className="space-y-3 text-sm">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <span className="font-semibold text-zinc-100 block">Por que fazer agora?</span>
                            <span className="text-zinc-400">{idea.whyNow}</span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <span className="font-semibold text-zinc-100 block">Seu Ângulo Único:</span>
                            <span className="text-zinc-400">{idea.angle}</span>
                          </div>
                        </div>

                        <div className="flex items-start gap-2 bg-transparent p-3 rounded-lg border border-zinc-100 mt-2">
                          <Youtube size={16} className="text-red-500 shrink-0 mt-0.5" />
                          <div>
                            <span className="font-semibold text-zinc-100 block text-xs uppercase tracking-wider mb-1">Contexto da Concorrência</span>
                            <span className="text-zinc-400 text-xs">{idea.competitorContext}</span>
                          </div>
                        </div>
                      </div>
