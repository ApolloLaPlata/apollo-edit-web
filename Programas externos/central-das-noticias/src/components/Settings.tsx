        ...
        <div className="flex justify-between items-center mb-1">
          ...
          {isTestable && (
            <button 
              ...
              className="text-xs text-indigo-600 hover:text-indigo-800 font-medium flex items-center gap-1 px-2 py-1 rounded hover:bg-indigo-900/30 transition-colors"
        ...
        <div className="relative">
          ...
          {isTextarea ? (
            <textarea 
              ...
              rows={3}
              className={`w-full pl-9 pr-4 py-2 bg-zinc-900 border ${status?.status === 'error' ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : status?.status === 'success' ? 'border-emerald-300 focus:ring-emerald-500 focus:border-emerald-500' : 'border-zinc-800 focus:ring-indigo-500 focus:border-indigo-500'} rounded-lg focus:ring-2 outline-none transition-all resize-none`}
            />
          ) : (
            <input 
              type="password" 
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-zinc-400 mt-1">Gerencie suas chaves de API, integrações com redes sociais e preferências gerais.</p>
      </div>

      {savedStatus && (
        <div className="bg-emerald-900/30 text-emerald-400 p-4 rounded-lg flex items-center gap-2 border border-emerald-200">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
                >
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-zinc-900 p-6 rounded-xl border border-zinc-800 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-medium bg-emerald-100 text-emerald-400 px-2 py-1 rounded-full">
                Dashboard em Breve
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Twitter */}
              <div className="p-4 border border-zinc-100 rounded-lg bg-transparent/50">
