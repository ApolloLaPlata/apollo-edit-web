...
export default function App() {
  ...
  // News Hunter State
  const [activeTab, setActiveTab] = useState<'strategy' | 'images' | 'news' | 'dashboard' | 'miner' | 'radar' | 'studio' | 'channel' | 'analytics' | 'monitor' | 'settings' | 'history' | 'scripts'>(() => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-zinc-100 font-sans flex">
      {/* Sidebar Spacer */}
      {!window.__APOLLO_EMBEDDED__ && (
        <div className="w-[68px] shrink-0"></div>
      )}

      {/* Sidebar */}
      {!window.__APOLLO_EMBEDDED__ && (
      <aside className="fixed top-0 left-0 h-screen bg-zinc-900 border-r border-zinc-800 flex flex-col z-50 w-[68px] hover:w-64 transition-all duration-300 overflow-hidden group">
        <div className="p-4 border-b border-zinc-800 flex items-center gap-3 whitespace-nowrap h-[65px] shrink-0 cursor-pointer hover:bg-indigo-900/30 transition-colors" onClick={() => window.location.href='../hub.html'}>
          <div className="bg-indigo-600 p-2 rounded-lg text-white shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></svg>
          </div>
          <h1 className="text-xl font-semibold tracking-tight opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-0 group-hover:w-auto overflow-hidden">Voltar ao Hub</h1>
        </div>
        
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto overflow-x-hidden">
          <button
            onClick={() => setActiveTab('strategy')}
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'strategy' ? 'bg-indigo-900/30 text-indigo-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'dashboard' ? 'bg-zinc-800 text-zinc-100' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'images' ? 'bg-indigo-900/30 text-indigo-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'news' ? 'bg-orange-900/30 text-orange-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'scripts' ? 'bg-indigo-900/30 text-indigo-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'miner' ? 'bg-red-900/30 text-red-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'radar' ? 'bg-red-900/30 text-red-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'studio' ? 'bg-indigo-900/30 text-indigo-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'channel' ? 'bg-red-900/30 text-red-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
            <Youtube size={18} className="shrink-0" />
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'analytics' ? 'bg-emerald-900/30 text-emerald-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'monitor' ? 'bg-emerald-900/30 text-emerald-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'history' ? 'bg-indigo-900/30 text-indigo-400' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors whitespace-nowrap ${activeTab === 'settings' ? 'bg-zinc-800 text-zinc-100' : 'text-zinc-400 hover:bg-transparent hover:text-zinc-100'}`}
          >
          ...
          <div className="flex items-center gap-4">
            <h2 className="text-lg font-bold text-white capitalize drop-shadow-md">
              {activeTab === 'strategy' ? 'Estratégia do Canal' :
               ...
               activeTab === 'scripts' ? 'Roteiros' : 'Configurações'}
            </h2>
          </div>
            ...
            {activeTab === 'images' && assets.length > 0 && (
              <div className="flex items-center gap-3 hidden sm:flex">
                ...
                <div className="w-32 h-2 bg-zinc-200 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-emerald-900/300 transition-all duration-500 ease-out"
            ...
            {activeTab === 'images' && hasImages && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-2 bg-zinc-900 border border-zinc-700 hover:bg-transparent text-zinc-700 px-4 py-2 rounded-md text-sm font-medium transition-colors"
        ...
        {activeTab === 'strategy' ? (
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <h2 className="text-2xl font-bold text-zinc-100">Painel Geral</h2>
                <button
                  onClick={() => {
                  ...
                  className="flex items-center gap-2 bg-zinc-900 border border-zinc-700 hover:bg-transparent text-zinc-700 px-3 py-1.5 rounded-md text-sm font-medium transition-colors"
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {['Geral', 'Política', 'Economia', 'Mundo', 'Tecnologia', 'Entretenimento'].map(cat => (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${dashboardCategory === cat ? 'bg-zinc-900 text-white' : 'bg-zinc-900 border border-zinc-800 text-zinc-400 hover:bg-transparent'}`}
                  >
                    {cat}
                  </button>
                ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {dashboardNews.map((item, index) => (
                  <div key={index} className="bg-zinc-900 rounded-xl border border-zinc-800 overflow-hidden hover:shadow-md transition-shadow flex flex-col">
                    {item.imageUrl && (
                      <div className="h-48 overflow-hidden bg-zinc-800 flex-shrink-0">
                        <img 
                    ...
                    <div className="p-4 flex-1 flex flex-col">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-xs font-semibold px-2 py-1 bg-zinc-800 text-zinc-400 rounded-md">
                          {item.source}
                        </span>
                        <span className="text-xs text-zinc-400">{item.date}</span>
                      </div>
                      <h3 className="font-bold text-zinc-100 mb-2 line-clamp-3 leading-snug">{item.title}</h3>
                      <p className="text-sm text-zinc-400 line-clamp-3 mb-4 flex-1">{item.summary}</p>
                      ...
                      <div className="flex items-center gap-2 mt-auto pt-4 border-t border-zinc-100">
                        <button 
                          ...
                          className="flex-1 bg-orange-900/30 hover:bg-orange-100 text-orange-400 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-1"
                        ...
                        <button 
                          ...
                          className="flex-1 bg-red-900/30 hover:bg-red-100 text-red-400 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-1"
                        ...
                        <button
                          ...
                          className="p-2 bg-transparent hover:bg-indigo-900/30 text-zinc-400 hover:text-indigo-600 rounded-md transition-colors"
          ...
          <div className="space-y-6">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full rounded-md bg-zinc-900 border border-zinc-700 shadow-sm focus:border-red-500 focus:ring-red-500 px-4 py-3 text-lg pr-10"
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
            ...
            {isMining ? (
              ...
              <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-12 text-center">
                ...
                <h3 className="text-lg font-medium text-zinc-100 mb-2">Nenhum vídeo encontrado</h3>
                <p className="text-zinc-400">Tente buscar por termos diferentes ou mais abrangentes.</p>
              </div>
            ) : (
              <div className="flex flex-col items-center justify-center py-20 text-zinc-400 border-2 border-dashed border-zinc-800 rounded-xl bg-transparent/50">
                ...
                <p className="text-lg font-medium text-zinc-400">Nenhum vídeo minerado ainda</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-6">
              {activeTab === 'images' ? (
              <div className="bg-zinc-900 rounded-xl shadow-sm border border-zinc-800 p-6 sticky top-24">
                ...
                <div className="mb-4">
                  ...
                  <input 
                    ...
                    className="w-full p-2 bg-zinc-900 border border-zinc-700 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                    disabled={isAnalyzing}
                  />
                </div>

                <div className="mb-4 flex items-center justify-between bg-transparent p-3 rounded-lg border border-zinc-800">
                  <div>
                    <label className="block text-sm font-medium text-zinc-100">Seleção Automática</label>
                    <p className="text-xs text-zinc-400">A IA escolhe a melhor imagem automaticamente.</p>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <label key={type.id} className={`flex items-center gap-2 p-2 rounded-md border cursor-pointer transition-colors ${allowedTypes[type.id as keyof typeof allowedTypes] ? 'bg-indigo-900/30 border-indigo-200 text-indigo-400' : 'bg-zinc-900 border-zinc-800 text-zinc-400 hover:bg-transparent'}`}>
                        <input
                          type="checkbox"
                          className="sr-only"
                ...
                {allowedTypes.ai_generated && (
                  <div className="mb-4 bg-indigo-900/30/50 p-3 rounded-lg border border-indigo-100 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="flex gap-2">
                      {[
                        ...
                        <button
                          ...
                          className={`flex-1 py-1.5 text-xs font-medium rounded-md border transition-colors ${aiAspectRatio === ratio.id ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-zinc-900 text-indigo-400 border-indigo-200 hover:bg-indigo-900/30'}`}
                        >
                          {ratio.label}
                        </button>
                      ))}
                ...
                <textarea
                  ...
                  className="w-full h-64 p-3 bg-zinc-900 border border-zinc-700 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none text-sm"
                  disabled={isAnalyzing}
                />
                ...
                <div className="mt-4 border-t border-zinc-800 pt-4 space-y-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-200 disabled:bg-transparent text-zinc-700 px-4 py-2.5 rounded-md text-sm font-medium transition-colors border border-zinc-700"
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-emerald-900/30 hover:bg-emerald-100 disabled:bg-transparent text-emerald-400 px-4 py-2.5 rounded-md text-sm font-medium transition-colors border border-emerald-200"
                  ...
                  {thumbnailIdeas && (
                    <div className="mt-4 bg-indigo-900/30/50 border border-indigo-100 rounded-lg p-4 animate-in fade-in slide-in-from-top-2 duration-200">
                      <div className="flex items-center gap-2 mb-2">
                  ...
                  {seoResult && (
                    <div className="mt-4 bg-emerald-900/30/50 border border-emerald-100 rounded-lg p-4 animate-in fade-in slide-in-from-top-2 duration-200">
                      <div className="flex items-center gap-2 mb-2">
                ...
                {error && (
                  <div className="mt-4 p-3 bg-red-900/30 text-red-400 rounded-md text-sm flex items-start gap-2">
                ...
                <div className="mt-6 flex flex-col gap-3">
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 bg-zinc-200 hover:bg-zinc-300 disabled:bg-zinc-800 disabled:text-zinc-400 text-zinc-700 px-4 py-3 rounded-md text-sm font-medium transition-colors"
                    >
                      <Trash2 size={16} />
                      Limpar
                    </button>
              ...
              <div className="bg-zinc-900 rounded-xl shadow-sm border border-zinc-800 p-6 sticky top-24">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium rounded-full border transition-colors ${
                          newsTopic.includes(topic)
                            ...
                            : 'bg-zinc-900 border-zinc-800 text-zinc-400 hover:bg-transparent disabled:opacity-50'
                        }`}
                      >
                        {topic}
                      </button>
                ...
                <div className="mb-4">
                  ...
                  <input 
                    ...
                    className="w-full p-2 bg-zinc-900 border border-zinc-700 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-sm"
                    disabled={isFetchingNews}
                  />
                </div>
                ...
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <label htmlFor="useGrok" className="text-sm font-medium text-zinc-700 flex items-center gap-1">
                    ...
                    <span className="text-xs bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">Requer API Key</span>
                  </label>
                </div>
            ...
            {activeTab === 'images' ? (
              <>
                {assets.length === 0 && !isAnalyzing ? (
                  <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-zinc-400 border-2 border-dashed border-zinc-800 rounded-xl bg-transparent/50">
                    <ImageIcon size={48} className="mb-4 opacity-50" />
                    <p className="text-lg font-medium text-zinc-400">Nenhum material extraído ainda</p>
                  ...
                  <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-indigo-500">
                    ...
                    <p className="text-sm text-zinc-400 mt-2">Isso pode levar alguns segundos.</p>
                  </div>
                ) : (
                  <div className="space-y-6">
                    {assets.map((asset, index) => {
                      ...
                      return (
                        <div 
                          key={asset.id} 
                          className={`bg-zinc-900 rounded-xl shadow-sm border transition-all duration-200 overflow-hidden ${
                            isDone ? 'border-emerald-200' : 'border-zinc-800'
                          }`}
                        >
                          <div className="p-5 border-b border-zinc-100 flex flex-col sm:flex-row gap-4">
                            <div className="flex-1">
                              ...
                              <h3 className={`text-lg font-medium mb-1 ${isDone ? 'text-zinc-400' : 'text-zinc-100'}`}>
                                {asset.description}
                              </h3>
                            ...
                            {isDone && (
                              <div className="w-full sm:w-48 flex flex-col gap-2 flex-shrink-0">
                                <div className="aspect-video sm:aspect-square bg-zinc-800 relative rounded-lg overflow-hidden border border-zinc-800">
                                  <img 
                                    src={asset.userImage} 
                                  ...
                                  <div className="absolute top-2 right-2 flex flex-col gap-2">
                                    <button 
                                      onClick={() => (window as any).addToTransferArea?.('image', 'Imagem Selecionada', asset.selectedSourceUrl || 'Desconhecido', asset.userImage)}
                                      className="bg-emerald-600/90 hover:bg-emerald-600 text-white p-1.5 rounded-full backdrop-blur-sm transition-colors shadow-sm"
                                      title="Enviar para Área de Transferência (HUD)"
                                    >
                                      🎒
                                    </button>
                                    <button 
                          ...
                          {!isDone && (
                            <div className="p-5 bg-transparent">
                              ...
                              {asset.autoImages && asset.autoImages.length > 0 ? (
                                    ...
                                    >
                                      ...
                                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 flex flex-col items-center justify-center gap-2 transition-colors">
                                        <button 
                                          ...
                                          className="bg-zinc-900 text-zinc-100 text-xs font-bold px-3 py-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity shadow-sm hover:bg-zinc-800"
                                        >
                                          Usar esta
                                        </button>
                                        {img.source && (
                                ...
                                <div className="text-sm text-zinc-400 italic mb-4">Nenhuma imagem automática encontrada.</div>
                              )}

                              <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-zinc-800">
                                <span className="text-sm text-zinc-400">Não gostou das opções?</span>
                                
                                <a
                                  href={`https://www.google.com/search?tbm=isch&q=${encodeURIComponent(asset.searchQuery)}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center gap-1.5 bg-zinc-900 border border-zinc-700 hover:bg-transparent text-zinc-700 px-3 py-1.5 rounded-md text-sm font-medium transition-colors"
                                >
                                  <Search size={14} />
                                  Buscar no Google
                                </a>

                                <label className="inline-flex items-center gap-1.5 bg-zinc-900 border border-zinc-700 hover:bg-transparent text-zinc-700 px-3 py-1.5 rounded-md text-sm font-medium transition-colors cursor-pointer">
                                  <UploadCloud size={14} />
                                  Fazer Upload
                                  <input 
                                    type="file" 
                                ...
                                <button
                                  ...
                                  className="inline-flex items-center gap-1.5 bg-indigo-900/30 border border-indigo-200 hover:bg-indigo-100 text-indigo-400 px-3 py-1.5 rounded-md text-sm font-medium transition-colors disabled:opacity-50"
              ...
              <>
                {newsItems.length === 0 && !isFetchingNews ? (
                  <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-zinc-400 border-2 border-dashed border-zinc-800 rounded-xl bg-transparent/50">
                    ...
                    <p className="text-lg font-medium text-zinc-400">Nenhuma notícia buscada ainda</p>
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
                      <h2 className="text-xl font-semibold text-zinc-200">Resultados para "{newsTopic}"</h2>
                      <div className="flex flex-wrap items-center gap-2">
                        <select
                          value={selectedTone}
                          onChange={(e) => handleToneChange(e.target.value)}
                          className="px-3 py-1.5 bg-zinc-900 border border-zinc-700 rounded-md text-sm font-medium text-zinc-700 focus:ring-2 focus:ring-indigo-500 outline-none"
                        ...
                        <button 
                          ...
                          disabled={isGeneratingScript || isGeneratingShorts}
                          className="flex items-center gap-2 bg-black hover:bg-zinc-800 disabled:bg-transparent0 text-white px-3 py-1.5 rounded-md text-sm font-medium transition-colors"
                        >
                    ...
                    {newsItems.map((item, index) => (
                      <div key={index} className="bg-zinc-900 rounded-xl shadow-sm border border-zinc-800 p-5 hover:border-orange-200 transition-colors flex flex-col sm:flex-row gap-4">
                        {item.imageUrl && (
                          <div className="w-full sm:w-32 h-32 flex-shrink-0 rounded-lg overflow-hidden bg-zinc-800 border border-zinc-800">
                            <img 
                              src={`/api/proxy-image?url=${encodeURIComponent(item.imageUrl)}`} 
                              alt={item.title}
                              className="w-full h-full object-cover"
                        ...
                        <div className="flex-1">
                          <div className="flex items-start justify-between gap-4 mb-2">
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                              ...
                              <button
                                onClick={() => (window as any).addToTransferArea?.('text', item.title, item.source, item.imageUrl)}
                                className="text-indigo-400 hover:text-indigo-300 hover:bg-indigo-900/30 p-1.5 rounded-md transition-colors flex items-center gap-1 border border-indigo-500/20 bg-indigo-900/10"
                                title="Enviar para Área de Transferência (HUD)"
                              >
                                <span className="text-xs font-medium">🎒 HUD</span>
                              </button>
                              <button
                                onClick={() => {
                                  const text = `Título: ${item.title}\nResumo: ${item.summary}\nFonte: ${item.source}\nLink: ${item.url}`;
                                ...
                                className="text-zinc-400 hover:text-indigo-600 hover:bg-indigo-900/30 p-1.5 rounded-md transition-colors"
                                title="Copiar notícia"
                              >
                                <Copy size={16} />
                              </button>
                              <button
                                ...
                                className="text-zinc-400 hover:text-red-600 hover:bg-red-900/30 p-1.5 rounded-md transition-colors"
                          ...
                          {deepDives[index] && (
                            <div className="mt-4 pt-4 border-t border-zinc-100 animate-in fade-in slide-in-from-top-2 duration-200">
                              ...
                              <div className="bg-indigo-900/30/50 rounded-lg p-4 text-sm text-zinc-700 whitespace-pre-wrap leading-relaxed">
                                {deepDives[index]}
                              </div>
                            </div>
                          )}
                          ...
                          {expandedScreenshot === index && (
                            <div className="mt-4 pt-4 border-t border-zinc-100 animate-in fade-in slide-in-from-top-2 duration-200">
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-xs font-medium text-zinc-400">Print automático da página:</span>
                                <a 
                              ...
                              <div className="rounded-lg overflow-hidden border border-zinc-800 bg-transparent relative min-h-[200px]">
                                <img 
      ...
      {hoveredPreview && (
        <div 
          className="hidden sm:block fixed z-[100] pointer-events-none bg-zinc-900 p-2 rounded-xl shadow-2xl border border-zinc-800 transition-all duration-200 ease-out"
          style={{
            top: '50%',
        ...
        >
          ...
          <img 
            ...
            alt="Preview" 
            className="w-auto h-auto max-w-[500px] max-h-[500px] min-w-[250px] min-h-[250px] object-contain rounded-lg bg-transparent/80"
            onError={(e) => {
              const target = e.target as HTMLImageElement;
              if (target.src.includes('/api/proxy-image')) {
