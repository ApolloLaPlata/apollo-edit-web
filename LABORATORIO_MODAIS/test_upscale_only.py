...
def test_upscale():
    ...
    # 2. Ler a imagem base
    input_image_path = "E:\\MEUS PROGRAMAS\\APOLLO_EDIT_WEB\\LABORATORIO_MODAIS\\elonmuskresultado_multipass_api_test - Copia.png"
    ...
    try:
        ...
        if result.get("status") == "success":
            ...
            if img_b64:
                ...
                out_path = f"E:\\MEUS PROGRAMAS\\APOLLO_EDIT_WEB\\LABORATORIO_MODAIS\\resultado_flux_upscale_0.png"
                img.save(out_path)
