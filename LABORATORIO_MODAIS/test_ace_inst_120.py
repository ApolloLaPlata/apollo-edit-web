...
def main():
    print("Iniciando Teste: Instrumental Puro de 120s (Testando Limites Matemáticos do LLM sem letras)...")
    
    os.makedirs("LABORATORIO_MODAIS/testes_audio", exist_ok=True)
    
    DURACAO = 120  # Cortando pela metade para ver se o DiT para de sobrepor faixas
    PASSOS = 64
...
[outro]""" 
    ...
    try:
        ...
        if result["status"] == "success":
            ...
            out_path = f"LABORATORIO_MODAIS/testes_audio/ACE_Instrumental_Puro_120s_{timestamp}.wav"
