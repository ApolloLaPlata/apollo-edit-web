...
app = modal.App("apollo-s2-matrix", image=s2_image)
...
def main():
    ...
    engine = TrueS2MatrixEngine()
    
    testes = [
        ("matrix_01_sad", "[crying and sobbing] Eu perdi tudo... por favor, me ajuda..."),
        ("matrix_02_sad", "[whispering and crying] Shhh... Não chora, não chora... snif..."),
        ("matrix_03_sad", "[sad and depressed] Eu não aguento mais viver assim."),
        ("matrix_04_sad", "[crying out loud] POR QUÊ?! Por que isso aconteceu comigo?!"),
        
        ("matrix_05_happy", "[laughing] HAHAHAHA! Meu Deus, isso é muito engraçado!"),
        ("matrix_06_happy", "[laughing out loud] Hahaha! Eu não acredito que você fez isso!"),
        ("matrix_07_happy", "[happy and excited] Isso é incrível! Eu consegui! Uhuuu!"),
        ("matrix_08_happy", "[chuckling] Hehehe, você não me engana, eu sabia disso."),
        
        ("matrix_09_angry", "[furious and shouting loudly] EU JÁ DISSE QUE NÃO! SAI DAQUI AGORA!"),
        ("matrix_10_angry", "[angry and aggressive] Presta muita atenção no que eu vou te falar!"),
        ("matrix_11_angry", "[shouting with rage] COMO VOCÊ TEVE A CORAGEM DE FAZER ISSO?!"),
        ("matrix_12_angry", "[gritted teeth and angry] Eu vou acabar com você.")
    ]
    
    save_dir = r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\LABORATORIO_MODAIS\resultados_emocionais\s2_real\matrix"
    os.makedirs(save_dir, exist_ok=True)
    
    for nome, texto in testes:
        print(f"\n-> Processando Matriz: {nome}")
