...
def main():
    ...
    jinx_path = r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\LABORATORIO_MODAIS\elon_musk_sorvete_txt2img.png"
    ...
    url = "https://filosofiadocodigo--apollo-render-router-apollo-api.modal.run/generate/autoblog/multipass"
    ...
    try:
        ...
        if result.get('status') == 'success':
            ...
            out_path = r"E:\MEUS PROGRAMAS\APOLLO_EDIT_WEB\LABORATORIO_MODAIS\resultado_multipass_api_test.png"
