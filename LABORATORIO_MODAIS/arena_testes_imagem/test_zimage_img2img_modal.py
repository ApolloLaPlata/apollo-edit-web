...
def test_zimage_img2img_modal():
    print("Iniciando teste Z-Image Img2Img...")
    ...
    workflow = {
        ...
        "4": { "class_type": "LoadImage", "inputs": { "image": "referencia_bombadao.jpg" }},
        ...
        "7": { "class_type": "CLIPTextEncode", "inputs": { "text": "bad quality, blurry, deformed, weird anatomy", "clip": ["2", 0] }},
        
        # Sampler (Denoise 0.7 for Img2Img)
        "8": { "class_type": "KSampler", "inputs": {
            "model": ["1", 0],
            "positive": ["6", 0],
            "negative": ["7", 0],
            "latent_image": ["5", 0],
            "seed": 888, "steps": 25, "cfg": 4.0, "sampler_name": "euler", "scheduler": "simple", "denoise": 0.75
        }},
        
        "9": { "class_type": "VAEDecode", "inputs": { "samples": ["8", 0], "vae": ["3", 0] }},
        "10": { "class_type": "SaveImage", "inputs": { "images": ["9", 0], "filename_prefix": "zimage_img2img" }}
    }
    ...
    print("Enviando JSON workflow para o servidor Modal Z-Image Img2Img...")
    ...
    try:
        ...
        if result.get("status") == "success":
            ...
            out_path = "E:/MEUS PROGRAMAS/APOLLO_EDIT_WEB/LABORATORIO_MODAIS/arena_testes_imagem/resultado_modal_zimage_img2img.jpg"
