...
def test_qwen_multi3():
    print("Iniciando teste 3 Personagens com Qwen...")
    ...
    workflow = {
        ...
        "6":  { "class_type": "TextEncodeQwenImageEditPlus", "inputs": {
            "clip": ["3", 0], 
            "prompt": "A dynamic 2d animation style scene in a futuristic cyberpunk city alley with neon lights. Three characters are interacting. On the left is Character 1 (image1). In the center is Character 2 (image2). On the right is Character 3 (image3). Vibrant colors, highly detailed.", 
            "vae": ["4", 0], 
            "image1": ["5b", 0],
            "image2": ["5d", 0],
            "image3": ["5f", 0]
        ...
        "9": { "class_type": "KSampler", "inputs": {
            ...
            "negative": ["7", 0],
            "latent_image": ["8", 0],
            "seed": 777, "steps": 25, "cfg": 2.5, "sampler_name": "euler", "scheduler": "simple", "denoise": 1.0
        }},
        "10": { "class_type": "VAEDecode", "inputs": { "samples": ["9", 0], "vae": ["4", 0] }},
        "11": { "class_type": "SaveImage", "inputs": { "images": ["10", 0], "filename_prefix": "qwen_multi3" }}
    }
    ...
    try:
        ...
        if result.get("status") == "success":
            ...
            out_path = "E:/MEUS PROGRAMAS/APOLLO_EDIT_WEB/LABORATORIO_MODAIS/arena_testes_imagem/resultado_modal_qwen_multi3.jpg"
