...
def main():
    print("Iniciando Teste: Instrumental 60s (Com ERG Lyric Desligado para matar as alucinações)...")
    ...
    call = engine.generate.spawn(
        ...
        steps=PASSOS,
        use_erg_lyric=False # A mágica recomendada pelos engenheiros do modelo!
    )
    ...
    try:
        ...
        if result["status"] == "success":
            ...
            out_path = f"LABORATORIO_MODAIS/testes_audio/ACE_Inst_60s_ERG_{timestamp}.wav"
