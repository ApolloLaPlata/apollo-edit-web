...
html = html.replace('<a href="${fileUrlAbs}" download class="btn btn-primary" style="white-space: nowrap; height: fit-content;">⬇️ Baixar</a>', '<button onclick="forceDownloadAudio(\\'${fileUrlAbs}\\')" class="btn btn-primary" style="white-space: nowrap; height: fit-content;">⬇️ Baixar</button>')
