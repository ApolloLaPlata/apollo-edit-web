...
split_token = 'class FluxTranslatedImg2ImgEngine:'
...
class FluxImg2ImgEngine:
    ...
    def load_model(self):
        ...
        print("[FluxImg2ImgEngine] Loading FLUX.1-dev native (Diffusers Img2Img)...")
        ...
        self.pipe.to("cuda")
        print("[FluxImg2ImgEngine] Pipeline loaded on GPU.")
